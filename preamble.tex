...
\usetikzlibrary{calc} % for coordinate interpolation
\usepackage{hyperref} % for \url (optional)
...
\newtheorem*{definition*}{Definition} % unnumbered version
% unnumbered theorem
\newtheorem*{theorem*}{Theorem} % unnumbered version
